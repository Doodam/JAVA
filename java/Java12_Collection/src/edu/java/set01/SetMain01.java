 ...
 * 
 * HashSet: Hash알고리즘(검색을 빠르게 할 수 있는 알고리즘)을 사용한 Set. 
 * TreeSet: Tree알고리즘(정렬을 빠르게 할 수 있는 알고리즘)을 사용한 Set.
 */
...
public class SetMain01 {
	...
	public static void main(String[] args) {
		...
		// for 문장을 사용할 수 없음. for-each문장과 Iterator 사용 가능.
		for(String x : set) {
			System.out.print(x + " ");
		}
		System.out.println();
		...
		Iterator<String> itr = set.iterator(); // .iterator(); 오름차순 반복 도구
		while(itr.hasNext()) {
			System.out.print(itr.next() + " ");
		}
		System.out.println();
		
		// TreeSet은 정렬 알고리즘이 적용된 객체이기 때문에 내침차순 반복 도구도 제공.
