...
public class ListMain02 {
	...
	public static void main(String[] args) {
		...
		// 리스트 numbers에 [0, 100) 0이상 100미만 범위의 정수 난수 20개를 저장.
		// 리스트 numbers의 내용을 출력.
		...
		for(Integer a : numbers) {	// 리스트 numbers의 원소들을 처음부터 끝까지 순회하면서
			if(a % 2 == 0) {	// 리스트의 원소가 짝수이면
				evenSquares.add(a * a); // 원소의 제곱을 저장.
			}
		}
		...
		while(itr.hasNext()) { // 현재 itr있는 위치 다음에 원소가 있나요?
