...
public class ContactMain {
	...
	private final ContactDaoImpl dao = ContactDaoImpl.getInstance(); // 연락처 정보 관리하는 객체(MVC에서 Controller)
	...
	// ContactUpdateFrame 에서 연락처 업데이트를 성공했을 때 호출할 메서드.
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 549, 669);
		...
		btnDelete.setFont(new Font("맑은 고딕", Font.BOLD, 25));
