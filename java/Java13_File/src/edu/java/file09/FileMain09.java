...
public class FileMain09 {
	...
	public static void main(String[] args) {
		...
		System.out.println("폴더인가요? " + f.isDirectory());
		System.out.println("파일의 크기 : " + f.length() + " byte"); // 파일단위: byte
		...
		if(newFolder.exists()) {
			newFolder.delete();
			System.out.println("폴더 삭제 성공 " + newFolder);
		} else {
			System.out.println("삭제 할폴더가 없습니다.");
		}
