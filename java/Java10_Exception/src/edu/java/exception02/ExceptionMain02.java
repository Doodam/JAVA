 ...
 * - 발생한 예외를 catch할 수 없으면 catch블록이 실행되지 못하고 프로그램은 비정상적으로 종료됨.
 ...
 * |__ Throwable
 * 	   |__ Exception
 * 		   |__ RuntimeExeption, IOException, FileNotFoundException, ...
...
//			System.out.println(e.getMessage());
			e.printStackTrace();
		} catch (Exception e) {	// Exception 클래스의 모든 하위 타입 예외들을 처리할 수 있음. 순서 중요!
			e.printStackTrace();
		}
