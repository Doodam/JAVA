...
public class InnerMain03 {
	...
	public static void main(String[] args) {
		...
		OnClickListener listener2 = new SaveButtonListener(); // 다형성
		
		// 4. OnClickListener를 버튼의 기능으로 설정.
		btnSave.setOnclickListener(listener2);
		
		// 5. btnSave의 click메서드 사용 -> btnSave가 가지고 있는 listener의 onClick() 호출.
		btnSave.click();
		
		// 6. 지역 클래스: 선언된 메서드 안에서만 사용 가능(객체 생성). -- > 2,3번을 한번에 만들 수 있음.
