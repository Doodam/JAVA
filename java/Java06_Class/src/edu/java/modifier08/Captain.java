package edu.java.modifier08;

// singleton(싱글톤): 오직 한번만 생성할 수 있는 객체.
// singleton = (1) private static 클래스 필드 + (2) private 생성자 + (3) public static 클래스
...
public class Captain {
	...
	// 생성된 Captain 타입의 객체의 주소 값을 저장하기 위한 필드.
	...
	public static Captain getInstance() {
		...
		return instance;	// Captain 타입 객체의 주소값을 리턴. = null값일때만 return = 한번만 생성할 수 있는 객체.
	}
}
