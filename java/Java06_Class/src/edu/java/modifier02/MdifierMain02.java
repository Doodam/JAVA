...
public class MdifierMain02 {

	public static void main(String[] args) {
//		edu.java.modifier01.AccessTest test = new edu.java.modifier01.AccessTest(1, 2, 3, 4); // import 선언문 없이 사용할 때.
		AccessTest test = new AccessTest(1, 2, 3, 4); // import 선언문 사용.
